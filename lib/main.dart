      ...
      child: StreamProvider<User>.value(
        ...
        child: MaterialApp(
          theme: ThemeData(
            ...
            iconTheme: IconThemeData(color: Color.fromRGBO(255, 255, 255, 0.3), size: 40),
            textTheme: TextTheme(
                headline2: GoogleFonts.poppins(color: Colors.white, fontSize: 28),
                headline3: GoogleFonts.poppins(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w500),
                headline5: GoogleFonts.poppins(color: Color.fromRGBO(255, 255, 255, 0.5), fontSize: 18),
                headline6: GoogleFonts.poppins(
                  color: Color.fromRGBO(255, 255, 255, 0.5),
                  fontSize: 15.0,
                ),
                headline4: GoogleFonts.poppins(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),
                bodyText1: GoogleFonts.poppins(
                  color: Colors.white,
                  fontSize: 20,
                ),
                bodyText2: GoogleFonts.poppins(color: Color.fromRGBO(255, 255, 255, 0.5), fontSize: 10),
                subtitle1: GoogleFonts.poppins(color: Color.fromRGBO(255, 255, 255, 0.3)),
                subtitle2: GoogleFonts.poppins(color: Color.fromRGBO(255, 255, 255, 0.5))),
